...
<h2>Why focus on Predictive Maintenance?</h2>

<%-- Output user details --%>
<p>The Right Tool application focuses on maintenance trending and how to predict when a failure is intimate. Corrective maintenance can be defined as a maintenance task performed to identify, isolate, and rectify a fault so that the failed equipment, machine, or asset can be restored to an operational condition within the tolerances or limits established for in-service operations.

Corrective maintenance is maintenance which is carried out after failure detection and is aimed at restoring an asset to a condition in which it can perform its intended function.</p>

<p>Preventive maintenance (PM) has the following meanings:

The care and servicing by qualified personnel for the purpose of maintaining equipment and facilities in satisfactory operating condition by providing for systematic inspection, detection, and correction of incipient failures either before they occur or before they develop into major defects.
...
While Preventive Maintenance includes the evaluation of particles in suspension in a lubricant, sound and vibration analysis of a machine.</p>

<p>The Value of Preventive and Predictive Maintenance
...
Will the man hours and money invested in the program outweigh emergency repairs? From our experience, we believe that when a program is properly operated the benefits exceed the costs.</p>

<p>Here are other important benefits of a properly operated preventive maintenance program:
